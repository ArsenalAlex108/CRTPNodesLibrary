...
/// <summary>
/// A wrapper root that can be converted <c>To()</c><c>&lt;TNode&gt;</c> of other type if <c>TNode</c> implements <c>IBuildableSingletonNode&lt;TNode, TResult&gt;</c>.
/// </summary>
...
public readonly struct ConvertibleSingletonRoot<TInput, T> : IReadOnlyNode<TInput>, IEquatable<ConvertibleSingletonRoot<TInput, T>> where TInput : IReadOnlyNode<TInput>
{
    ...
    /// <summary>
    /// Converts to <c>TNode</c> if <c>TNode</c> implements <c>IBuildableSingletonNode&lt;TNode, TResult&gt;</c>.
    /// </summary>
    /// <typeparam name="TNode"></typeparam>
    /// <returns></returns>
    public TNode To<TNode>() where TNode : IBuildableSingletonNode<TNode, T> => TNode.ToSingletonNode(Root, Selector, ItemComparer);
