...
/// <summary>
/// Two trees are structurally equal when they have the same "shape" and <c>NodeComparer&lt;T&gt;</c> returns true for each node.
/// </summary>
/// <typeparam name="T"></typeparam>
public sealed class TreeStructuralEqualityComparer<T> : IEqualityComparer<T> where T : IReadOnlyNode<T>
{
    private TreeStructuralEqualityComparer()
    {
